    ...
    <div className="min-h-screen bg-background py-12 px-4">
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Keep your details up to date so musicians know who they&apos;re working with.</p>
        </div>

        <Card>
          <CardHeader>
            <CardTitle>Your details</CardTitle>
            <CardDescription>This information is visible to musicians you contact or hire.</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <Textarea
                  id="bio"
                  placeholder="Tell musicians a bit about you or your organization..."
                  value={form.bio}
