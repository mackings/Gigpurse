  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-2 tracking-tight">My Jobs</h1>
          <p className="text-muted-foreground">Track the gigs you&apos;ve applied to and booked.</p>
        </div>
