...
func (r *reviewRepository) GetByJobAndReviewer(ctx context.Context, jobID, reviewerID string) (*domain.Review, error) {
	var review domain.Review
	err := r.collection.FindOne(ctx, bson.M{"job_id": jobID, "reviewer_id": reviewerID}).Decode(&review)
	if err != nil {
