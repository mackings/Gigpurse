...
func (u *disputeUsecase) OpenDispute(ctx context.Context, userID, contractID, reason string) (*domain.Dispute, error) {
	...
	u.notify(ctx, contract.ClientID, "Dispute Opened", "A dispute was opened on your contract.", "/disputes")
	u.notify(ctx, contract.MusicianID, "Dispute Opened", "A dispute was opened on your contract.", "/disputes")
	return dispute, nil
}
...
func (u *disputeUsecase) ResolveDispute(ctx context.Context, disputeID, resolution string) (*domain.Dispute, error) {
	...
	if err == nil && contract != nil {
		u.notify(ctx, contract.ClientID, "Dispute Resolved", resolution, "/disputes")
		u.notify(ctx, contract.MusicianID, "Dispute Resolved", resolution, "/disputes")
	}
	return dispute, nil
}
